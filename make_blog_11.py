...
src_img = r"C:\Users\Techbuild Hub\.gemini\antigravity-ide\brain\d568cefd-61e0-420a-9a47-5378b3fb6610\blog11_diabetic_knee_replacement_1788174423241.jpg"
dest_img = os.path.join(base_dir, "assets", "blog11image1.jpg")
if os.path.exists(src_img):
    shutil.copyfile(src_img, dest_img)
    print("Copied blog11image1.jpg to assets.")
else:
    print("Warning: Source image not found at", src_img)

# 2. Build knee-replacement-for-diabetic-patients.html
src_html = os.path.join(base_dir, "can-knee-arthritis-be-treated-without-surgery.html")
dest_html = os.path.join(base_dir, "knee-replacement-for-diabetic-patients.html")
...
toc_html = """
            ...
            <details class="toc-card" open style="background: var(--bg-card); border: 1px solid var(--border); border-radius: var(--radius); padding: 24px; margin-bottom: 32px; box-shadow: var(--shadow-sm);">
              <summary style="font-family: var(--font-head); font-size: 1.1rem; font-weight: 700; color: var(--text-primary); display: flex; align-items: center; justify-content: space-between;">
                ...
                <svg class="toc-chevron" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="6 9 12 15 18 9"></polyline></svg>
              </summary>
              <ul style="list-style: none; padding: 0; margin: 16px 0 0 0; display: grid; gap: 10px; font-size: 0.92rem;">
...
start_body = content.find('<div class="article-body">')
end_body = content.find('<!-- Author Bio Card -->')

if start_body != -1 and end_body != -1:
    content = content[:start_body] + body_html + "\n\n            " + content[end_body:]
else:
    print("Error: Could not locate article-body bounds!")

with open(dest_html, "w", encoding="utf-8") as f:
    f.write(content)

print("Created knee-replacement-for-diabetic-patients.html successfully.")

# 3. Update blog.html to add Blog 11 Card at the top of blogGrid
blog_html_path = os.path.join(base_dir, "blog.html")
with open(blog_html_path, "r", encoding="utf-8") as f:
    blog_page = f.read()

blog_card_11 = """        <article class="blog-card">
          <div class="blog-card-img-wrap">
            <div class="blog-card-img">
              <img src="assets/blog11image1.jpg" alt="Knee Replacement for Diabetic Patients: Is It Safe?" style="width: 100%; height: 100%; object-fit: cover; display: block;">
            </div>
            <div class="blog-category-badge blue">Diabetes & Joint Care</div>
          ...
          <div class="blog-card-body">
            ...
            <h3 class="blog-card-title">
              <a href="knee-replacement-for-diabetic-patients.html" style="text-decoration: none; color: inherit;">Knee Replacement for Diabetic Patients: Is It Safe?</a>
            </h3>
            <p class="blog-card-excerpt">Learn about the safety, potential risks, blood sugar control guidelines, preoperative preparation, and recovery for diabetic patients undergoing knee replacement.</p>
            <div class="blog-card-footer">
              ...
              <a href="knee-replacement-for-diabetic-patients.html" class="blog-read-btn">
                Read More
...
if grid_marker in blog_page:
    blog_page = blog_page.replace(grid_marker, grid_marker + "\n" + blog_card_11)
    with open(blog_html_path, "w", encoding="utf-8") as f:
        f.write(blog_page)
    print("Updated blog.html with blog 11 card.")
else:
    print("Warning: Could not find blogGrid marker in blog.html")
...
sitemap_entry = """<url>
<loc>https://drmadhuramchowdryortho.com/knee-replacement-for-diabetic-patients.html</loc>
<priority>0.70</priority>
</url>
"""

if "knee-replacement-for-diabetic-patients.html" not in sitemap:
    sitemap = sitemap.replace("</urlset>", sitemap_entry + "</urlset>")
    with open(sitemap_path, "w", encoding="utf-8") as f:
        f.write(sitemap)
    print("Updated sitemap.xml with blog 11 URL.")
